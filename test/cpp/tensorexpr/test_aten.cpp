...
void testATen_cast_Float() {
  ...
  Expr store_b = Store::make(b_buf, index, to_float, 1);
  Expr stmt = For::make(index, 0, kTotalSize, store_b);
...
void testATenaddInt() {
  ...
  Expr store_d = Store::make(d_buf, index, load_a + load_b * load_c, 1);
  Expr stmt = For::make(index, 0, kTotalSize, store_d);
...
void testATenaddcmulInt() {
  ...
  Expr stmt = For::make(index, 0, kTotalSize, store_e);
...
void testATenmulInt() {
  ...
  Expr load_a = Load::make(a_buf, index, 1);
  Expr load_b = Load::make(b_buf, index, 1);
  Expr store_c = Store::make(c_buf, index, load_a * load_b, 1);
  Expr stmt = For::make(index, 0, kTotalSize, store_c);
...
void testATenmaxInt() {
  ...
  Expr load_a = Load::make(a_buf, index, 1);
  Expr load_b = Load::make(b_buf, index, 1);
  Expr store_c = Store::make(c_buf, index, Max::make(load_a, load_b, true), 1);
  Expr stmt = For::make(index, 0, kTotalSize, store_c);
...
void testATenminInt() {
  ...
  Expr load_a = Load::make(a_buf, index, 1);
  Expr load_b = Load::make(b_buf, index, 1);
  Expr store_c = Store::make(c_buf, index, Min::make(load_a, load_b, true), 1);
  Expr stmt = For::make(index, 0, kTotalSize, store_c);
...
void testATenreciprocal() {
  ...
  Var index = Var("index", kInt32);
  Expr load_a = Load::make(a_buf, index, 1);
  Expr store_b = Store::make(b_buf, index, FloatImm::make(1.0f) / load_a, 1);
  Expr stmt = For::make(index, 0, kTotalSize, store_b);
...
void testATenreluInt() {
  ...
  Var index = Var("index", kInt32);
  Expr load_a = Load::make(a_buf, index, 1);
  Expr store_b = Store::make(b_buf, index, Max::make(load_a, 0, false), 1);
  Expr stmt = For::make(index, 0, kTotalSize, store_b);
...
void testATenlogFloat() {
  ...
  Var index = Var("index", kInt32);
  Expr load_a = Load::make(a_buf, index, 1);
  Expr store_b = Store::make(b_buf, index, log(load_a), 1);
  Expr stmt = For::make(index, 0, kTotalSize, store_b);
...
void testATenlog10Float() {
  ...
  Var index = Var("index", kInt32);
  Expr load_a = Load::make(a_buf, index, 1);
  Expr store_b = Store::make(b_buf, index, log10(load_a), 1);
  Expr stmt = For::make(index, 0, kTotalSize, store_b);
...
void testATenlog2Float() {
  ...
  Var index = Var("index", kInt32);
  Expr load_a = Load::make(a_buf, index, 1);
  Expr store_b = Store::make(b_buf, index, log2(load_a), 1);
  Expr stmt = For::make(index, 0, kTotalSize, store_b);
...
void testATenexpFloat() {
  ...
  Var index = Var("index", kInt32);
  Expr load_a = Load::make(a_buf, index, 1);
  Expr store_b = Store::make(b_buf, index, exp(load_a), 1);
  Expr stmt = For::make(index, 0, kTotalSize, store_b);
...
void testATenerfFloat() {
  ...
  Var index = Var("index", kInt32);
  Expr load_a = Load::make(a_buf, index, 1);
  Expr store_b = Store::make(b_buf, index, erf(load_a), 1);
  Expr stmt = For::make(index, 0, kTotalSize, store_b);
...
void testATencosFloat() {
  ...
  Var index = Var("index", kInt32);
  Expr load_a = Load::make(a_buf, index, 1);
  Expr store_b = Store::make(b_buf, index, cos(load_a), 1);
  Expr stmt = For::make(index, 0, kTotalSize, store_b);
